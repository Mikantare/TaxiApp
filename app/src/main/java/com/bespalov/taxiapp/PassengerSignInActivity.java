...
public class PassengerSignInActivity extends AppCompatActivity {
    ...
    private TextInputLayout textInputEmail, textInputName, textInputPassword, textComfirmPassword;
    ...
    private boolean validetePassword() {
        ...
        String passwordComfirmInput = textComfirmPassword.getEditText().getText().toString().trim();
